...
export default function Body() {
  ...
  const props3 = useSpring({
    to: isScrolled ? { opacity: 1, x: 0 } : { opacity: 0, x: 0 },
    from: { opacity: 0, x: 25 },
    delay: 300,
    config: { mass: 3, tension: 1700, friction: 1000, duration: 250 },
    reset: false,
  ...
  useEffect(() => {
    window.onscroll = () => {
      setToggle(window.pageYOffset > 380 ? true : false);
    ...
    <div>
      ...
      >
        ...
        <animated.div style={props2}>
          ...
          <p className=' max-w-3xl m-auto mt-2 border-t-2 text-gray-600 leading- tracking-wide antialiased'>
            Passionate about learning and improving all the time. Creating
            simple, yet powerful designs. Integer et rutrum orci, vitae volutpat
            lorem. Vivamus purus felis, dictum vitae vestibulum non, bibendum
            vel nisl. Duis nec dignissim nulla, sit amet vehicula est. Nulla ac
            sem lectus. Vestibulum ullamcorper enim vitae massa tincidunt
            pretium ac scelerisque erat. Cras finibus iaculis sagittis. Aliquam
            vehicula lacinia diam, ut semper risus volutpat et. Integer vitae
            dolor consectetur, semper nulla vel, blandit risus. Donec in
            vestibulum tellus. Aenean metus arcu, vestibulum vel pharetra in,
            sodales eget nunc. Nunc scelerisque egestas odio, a cursus mi tempor
            sit amet.
          </p>
        </animated.div>
      </main>
